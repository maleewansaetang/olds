				...
				<div class="row text-center pad-top">
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="AddGrayBread.jsp"> <i class="fa fa-plus fa-5x"></i>
								<h4>Add Grandsire</h4>
							</a>
						</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="RoomServlet"> <i class="fa fa-home fa-5x"></i>
								<h4>Room</h4>
							</a>
						</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="checkin.jsp"> <i class="fa fa-usd fa-5x"></i>
								<h4>Check In</h4>
							</a>
						</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="officer.jsp"> <i class="fa fa-male fa-5x"></i>
								<h4>Officer</h4>
							</a>
						</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="Activities.jsp"> <i class="fa fa-bell-o fa-5x"></i>
								<h4>Activities</h4>
							</a>
						</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
						<div class="div-square">
							<a href="doctor.jsp"> <i class="fa fa-user-md fa-5x"></i>
								<h4>Doctor</h4>
							</a>
						</div>
